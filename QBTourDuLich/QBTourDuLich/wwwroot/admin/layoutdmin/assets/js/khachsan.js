...
function getAllKhachsan() {
    $.ajax({
        url: `https://localhost:7079/api/APIKhachSan`,
        method: 'GET',
        contentType: 'json',
        dataType: 'json',
        ...
        success: function (response) {
            ...
            const pageSize = 5;
            $.ajax({
                url: `https://localhost:7079/api/APIKhachSan/getPagination?pageSize=${pageSize}&pagenumber=${pageNumber}`,
                method: 'GET',
                contentType: 'json',
                dataType: 'json',
                error: function (response) {
...
function InsertKS() {
    ...
    var url = 'https://localhost:7079/api/APIKhachSan/themKS';
    $.ajax({
        url: url,
        method: 'POST',
        processData: false,
...
function UpdateKS() {
    ...
    var url = 'https://localhost:7079/api/APIKhachSan/capnhatKS';
    $.ajax({
        url: url,
        method: 'PUT',
        processData: false,
...
function updateKSFill(id) {
    var url = 'https://localhost:7079/api/APIKhachSan/getById?id=' + id;
    $.ajax({
        url: url,
        method: 'GET',
        contentType: 'json',
...
function deleteKS(id) {
    var url = 'https://localhost:7079/api/APIKhachSan?input=' + id;
    $.ajax({
        url: url,
        method: 'DELETE',
        contentType: 'json',
