...
function getAllTour() {
    $.ajax({
        url: `https://localhost:7079/api/APITour`,
        method: 'GET',
        contentType: 'json',
        dataType: 'json',
        ...
        success: function (response) {
            ...
            const pageSize = 5;
            $.ajax({
                url: `https://localhost:7079/api/APITour/getPagination?pageSize=${pageSize}&pagenumber=${pageNumber}`,
                method: 'GET',
                contentType: 'json',
                dataType: 'json',
                error: function (response) {
...
function InsertTour() {
    ...
    var url = 'https://localhost:7079/api/APITour/themTour';
    $.ajax({
        url: url,
        method: 'POST',
        processData: false,
...
function UpdateTour() {
    ...
    var url = 'https://localhost:7079/api/APITour/capnhatTour';
    $.ajax({
        url: url,
        method: 'PUT',
        processData: false,
...
function updateTourFill(id) {
    var url = 'https://localhost:7079/api/ApiTour/getById?id=' + id;
    $.ajax({
        url: url,
        method: 'GET',
        contentType: 'json',
...
function deleteTour(id) {
    var url = 'https://localhost:7079/api/ApiTour?input=' + id;
    $.ajax({
        url: url,
        method: 'DELETE',
        contentType: 'json',
