...
function getAllTaikhoan() {
    $.ajax({
        url: `https://localhost:7079/api/apitaikhoan`,
        method: 'GET',
        contentType: 'json',
        dataType: 'json',
        ...
        success: function (response) {
            ...
            const pageSize = 5;
            $.ajax({
                url: `https://localhost:7079/api/apitaikhoan/getPagination?pageSize=${pageSize}&pagenumber=${pageNumber}`,
                method: 'GET',
                contentType: 'json',
                dataType: 'json',
                error: function (response) {
...
function InsertTK() {
    ...
    var url = 'https://localhost:7079/api/apitaikhoan/themTK';
    $.ajax({
        url: url,
        method: 'POST',
        processData: false,
...
function deleteTK(id) {
    var url = 'https://localhost:7079/api/Apitaikhoan?input=' + id;
    $.ajax({
        url: url,
        method: 'DELETE',
        contentType: 'json',
