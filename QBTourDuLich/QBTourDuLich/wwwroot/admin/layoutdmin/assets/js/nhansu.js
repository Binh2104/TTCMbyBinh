...
function getAllNhanvien() {
    $.ajax({
        url: `https://localhost:7079/api/apinhanvien`,
        method: 'GET',
        contentType: 'json',
        dataType: 'json',
        ...
        success: function (response) {
            ...
            const pageSize = 5;
            $.ajax({
                url: `https://localhost:7079/api/apinhanvien/getPagination?pageSize=${pageSize}&pagenumber=${pageNumber}`,
                method: 'GET',
                contentType: 'json',
                dataType: 'json',
                error: function (response) {
...
function InsertNV() {
    ...
    var url = 'https://localhost:7079/api/apinhanvien/themNV';
    $.ajax({
        url: url,
        method: 'POST',
        processData: false,
...
function UpdateNV() {   
    ...
    var url = 'https://localhost:7079/api/apinhanvien/capnhatNV';
    $.ajax({
        url: url,
        method: 'PUT',
        processData: false,
...
function updateNVFill(id) {
    var url = 'https://localhost:7079/api/ApiNhanVien/getById?id=' + id;
    $.ajax({
        url: url,
        method: 'GET',
        contentType: 'json',
...
function deleteNV(id) {
    var url = 'https://localhost:7079/api/ApiNhanVien?input=' + id;
    $.ajax({
        url: url,
        method: 'DELETE',
        contentType: 'json',
