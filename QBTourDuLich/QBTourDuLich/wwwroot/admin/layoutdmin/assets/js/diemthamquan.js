...
function getAllDiemThamQuan() {
    $.ajax({
        url: `https://localhost:7079/api/APIDiemThamQuan`,
        method: 'GET',
        contentType: 'json',
        dataType: 'json',
        ...
        success: function (response) {
            ...
            const pageSize = 3;
            $.ajax({
                url: `https://localhost:7079/api/APIDiemThamQuan/getPagination?pageSize=${pageSize}&pagenumber=${pageNumber}`,
                method: 'GET',
                contentType: 'json',
                dataType: 'json',
                error: function (response) {
...
function InsertDiemThamQuan() {
    ...
    var url = 'https://localhost:7079/api/APIDiemThamQuan/themDTQ';
    $.ajax({
        url: url,
        method: 'POST',
        processData: false,
...
function UpdateDTQ() {
    ...
    var url = 'https://localhost:7079/api/APIDiemThamQuan/capnhatDTQ';
    $.ajax({
        url: url,
        method: 'PUT',
        processData: false,
...
function updateDTQFill(id) {
    var url = 'https://localhost:7079/api/ApiDiemThamQuan/getById?id=' + id;
    $.ajax({
        url: url,
        method: 'GET',
        contentType: 'json',
...
function deleteDTQ(id) {
    var url = 'https://localhost:7079/api/ApiDiemThamQuan?input=' + id;
    $.ajax({
        url: url,
        method: 'DELETE',
        contentType: 'json',
